        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class='mt-8 min-h-screen'>  <div class="rounded-xl border p-5 shadow-md w-9/12 bg-white">
                        ...
                        <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
                            <div class='max-w-md mx-auto space-y-6'>
                                ...
                                <form action="{{ route('applications.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <textarea name="message" class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded" id="text" cols="30" rows="10"></textarea>
                                    ...
                                    <input type="submit"  class="py-3 px-6 my-2 bg-emerald-500 text-white font-medium rounded cursor-pointer ease-in-out duration-300" value="Send">
                                </form>
                                @if(session('success'))
